...
public class scriptScreenWin : MonoBehaviour {
	...
	// Inspector variables
	public string winQuote = "Yeah! You WIN!!";
	...
	void OnGUI ()
	{
		...
		GUI.BeginGroup (new Rect(Screen.width / 2 - 120,Screen.height / 2 - 50,240,150));
		
		//Make a box to see the group on screen
		GUI.Box (new Rect(0,0,240,150),winQuote);		// Uses designer input	
